  ...
  return (
    <section id="submit" className="py-14 md:py-18 bg-transparent relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl bg-gradient-to-br from-[#081627] via-[#0b284c] to-[#0f3b6c] text-white p-7 sm:p-10 lg:p-14 overflow-hidden shadow-xl border border-amber-400/30">
