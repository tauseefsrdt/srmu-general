...
import { brandInfo } from '../data/generalData';

export default function Hero({ onOpenContact, onOpenProjects }) {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
            ...
            <div className="hero-badge flex flex-wrap items-center gap-2">
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-slate-900 text-white text-xs font-semibold shadow-sm border border-slate-700">
                ...
                <span>Enterprise Cloud & AI Solutions</span>
              </div>
            ...
            <div className="hero-headline space-y-2">
              <span className="text-xs font-bold uppercase tracking-widest text-amber-600 block">
                Pioneering Scalable Architecture
              </span>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-[#0f3b6c] tracking-tight leading-[1.15]">
                Architecting Intelligent Systems for{' '}
            ...
            <div className="hero-desc space-y-3 max-w-2xl text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              <p>
                {brandInfo.shortDesc} We partner with Fortune 500 organizations and ambitious digital scaleups to modernize architectures, accelerate development velocity, and engineer high-impact solutions.
              </p>
            </div>
            ...
            <div className="pt-4 border-t border-slate-200/80 w-full">
              <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400 block mb-2">
                Certified Enterprise Standards & Partners
              </span>
              <div className="flex flex-wrap items-center gap-2">
                {["SOC2 Type II Certified", "AWS Advanced Tier Partner", "ISO 27001 Security", "Kubernetes Certified", "GCP Premier Partner"].map((badge, idx) => (
                  <span
                    key={idx}
          ...
          {/* Right Column: Layered Visual Presentation */}
          <div className="lg:col-span-5 relative flex justify-center items-center">
            ...
            >
              <div className="relative overflow-hidden rounded-xl bg-gradient-to-b from-[#0f3b6c] to-[#081627] text-white aspect-[4/4.8] flex flex-col justify-between p-6 shadow-inner border border-amber-400/20">
                ...
                <div className="relative z-10 space-y-2">
                  ...
                  <div className="pt-2">
                    ...
                    <p className="text-[11px] text-amber-200/90 leading-tight">
                      Intelligent Distributed Systems & Cloud Orchestration
                    </p>
                  </div>
                </div>
                ...
                <div className="relative z-10 my-auto py-3">
                  <div className="relative rounded-lg overflow-hidden border border-white/15 group-hover:scale-[1.02] transition-transform duration-500 shadow-lg">
                    <img 
                      ...
                      alt="Modern Data Architecture and Analytics" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-transparent to-transparent flex items-end p-3">
                      <div className="flex items-center space-x-2 text-white">
                        ...
                        <span className="text-xs font-semibold">
                          45,000 TPS • Sub-Millisecond Global Routing
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative z-10 pt-2 border-t border-white/15 flex items-center justify-between text-[10px] text-slate-300">
                  <div className="flex flex-col">
                    <span className="font-bold text-white">Global Execution Mesh</span>
                    <span className="text-slate-400">Multi-Region Active-Active</span>
                  </div>
              ...
              <div className="hero-floating-card absolute -top-4 -right-4 sm:-right-6 bg-white/95 backdrop-blur-md rounded-xl p-3 shadow-lg border border-slate-200/90 flex items-center space-x-2.5 animate-float">
                ...
                <div>
                  <div className="text-xs font-bold text-slate-900">$4.2B+ Value</div>
                  <div className="text-[10px] text-slate-500 font-medium">Delivered to Clients</div>
                </div>
              </div>
              ...
              <div className="hero-floating-card absolute -bottom-4 -left-4 sm:-left-6 bg-white/95 backdrop-blur-md rounded-xl p-3 shadow-lg border border-slate-200/90 flex items-center space-x-2.5 animate-float [animation-delay:2s]">
                ...
                <div>
                  <div className="text-xs font-bold text-slate-900">99.99% SLA</div>
                  <div className="text-[10px] text-slate-500 font-medium">Zero-Downtime Migration</div>
                </div>
              </div>
