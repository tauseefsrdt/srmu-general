...
export default function ParticlesBackground() {
  ...
  useEffect(() => {
    ...
    // Particle nodes matching theme palette: Navy blue, sky blue, warm amber/gold
    const colors = [
      'rgba(15, 59, 108, 0.45)', // Theme Navy
      'rgba(2, 132, 199, 0.45)',  // Theme Sky Blue
      'rgba(245, 158, 11, 0.55)', // Theme Warm Amber/Gold
      'rgba(217, 119, 6, 0.4)'    // Theme Deep Gold
    ];
