      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="space-y-6">
          ...
          <div className="patrons-header flex items-center justify-center space-x-4">
            <div className="h-px bg-slate-300/80 flex-1 max-w-[120px] sm:max-w-xs"></div>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0f3b6c] tracking-tight text-center">
              Patrons
            </h2>
            <div className="h-px bg-slate-300/80 flex-1 max-w-[120px] sm:max-w-xs"></div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 lg:gap-6 items-stretch">
            {patronsData.patrons.map((patron) => (
              <div
                key={patron.id}
                className="patron-card glass-card glass-card-hover rounded-2xl p-5 sm:p-6 flex flex-col items-center text-center group"
              >
                {/* Circular Portrait - Sized proportionally */}
                <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full p-1 golden-ring-glow group-hover:scale-105 transition-transform duration-300 mb-4">
                ...
                {/* Name */}
                <h3 className="text-base sm:text-lg font-bold text-[#0f3b6c] group-hover:text-blue-800 transition-colors leading-snug">
                  {patron.name}
                </h3>
